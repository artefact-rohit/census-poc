                  ...
                  return (
                    <div>
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          cn(
                            "flex items-center space-x-2 px-3 pt-2 rounded-lg text-sm font-medium transition-colors",
                            isActive
                              ? "bg-primary text-primary-foreground"
                              : "text-muted-foreground hover:text-card-foreground hover:bg-secondary",
                            item.name == "Registers" ||
                              item.name == "Datasets" ||
                              item.name == "Dissemination"
                              ? ""
                              : "pb-2"
                          )
                        }
                      ...
                      <div className="text-xs text-muted-foreground text-center text-red-500">
                        {(item.name == "Registers" ||
                          item.name == "Datasets" ||
                          item.name == "Dissemination") &&
                          "(Coming Soon)"}
