...
export const IndicatorList = ({ indicators, selectedIndicator, onSelectIndicator }: IndicatorListProps) => {
  ...
  const filteredIndicators = indicators.filter(indicator => {
    ...
    const matchesBasket = selectedBasket === "all" || indicator.basket === selectedBasket;
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "completed": return "bg-status-success/10 border-status-success/20";
      case "validated": return "bg-status-success/10 border-status-success/20";
      case "in-progress": return "bg-status-warning/10 border-status-warning/20";
      case "delayed": return "bg-status-danger/10 border-status-danger/20";
        ...
        <div className="space-y-3">
          ...
          <Select value={selectedBasket} onValueChange={setSelectedBasket}>
            ...
            <SelectContent>
              ...
              <SelectItem value="Family Characteristics">Family Characteristics</SelectItem>
              <SelectItem value="Economic Characteristics">Economic Characteristics</SelectItem>
              <SelectItem value="Buildings & Units">Buildings & Units</SelectItem>
          ...
          {filteredIndicators.map((indicator) => (
            ...
            >
              ...
              <div className="flex justify-between items-center mt-2 text-xs">
                <span className="text-muted-foreground">Coverage: {indicator.coverage}%</span>
                <span className="text-muted-foreground">QDTI: {indicator.qdti}%</span>
              </div>
            </div>
          ))}
