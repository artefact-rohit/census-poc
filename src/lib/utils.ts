  ...
  overview: {
    listCardData: {
      indicators: {
        ...
        total: 131,
        baskets: {
          population: { completed: 28, total: 35 },
          family: { completed: 22, total: 28 },
          economic: { completed: 18, total: 25 },
          buildings: { completed: 15, total: 22 },
          establishments: { completed: 15, total: 21 },
        },
        weeklyProgress: 12,
        plannedVsActual: 94.2,
      },
      registers: {
        completed: 10,
        total: 13,
