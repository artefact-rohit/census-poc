  ...
  overview: {
    cardData: {
      indicators: {
        ...
        baskets: {
          "not-started": {
            population: { completed: 0, total: 35 },
            family: { completed: 0, total: 28 },
            economic: { completed: 0, total: 25 },
            buildings: { completed: 0, total: 22 },
            establishments: { completed: 0, total: 21 },
          },
          "in-progress": {
            population: { completed: 7, total: 35 },
            family: { completed: 6, total: 28 },
            economic: { completed: 7, total: 25 },
            buildings: { completed: 7, total: 22 },
            establishments: { completed: 6, total: 21 },
          },
          computed: {
            population: { completed: 18, total: 35 },
            family: { completed: 14, total: 28 },
            economic: { completed: 12, total: 25 },
            buildings: { completed: 11, total: 22 },
            establishments: { completed: 10, total: 21 },
          },
          validated: {
            population: { completed: 5, total: 35 },
            family: { completed: 4, total: 28 },
            economic: { completed: 3, total: 25 },
            buildings: { completed: 2, total: 22 },
            establishments: { completed: 2, total: 21 },
          },
        },
        weeklyProgress: 12,
        planned: 10.5,
